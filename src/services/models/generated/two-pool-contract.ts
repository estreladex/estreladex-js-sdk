...
export const networks = {
  testnet: {
    ...
    contractId: 'CBG7HCN3U62FAODOHJDIE3CZT7WZIKPRBYNZARQTT5H52Z4MQT6SOH2P',
  },
} as const;

export interface TwoPool {
  a: u128;
...
export interface TwoPoolContract {
  /**
  ...
  get_pool: (options?: {
     ...
     */
    simulate?: boolean;
  }) => Promise<AssembledTransaction<Result<TwoPool>>>;
   ...
   */
  get_receive_amount: (
    { input, token_from, token_to }: { input: u128; token_from: TwoToken; token_to: TwoToken },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
   ...
   */
  get_send_amount: (
    { output, token_from, token_to }: { output: u128; token_from: TwoToken; token_to: TwoToken },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
...
export class TwoPoolContract extends ContractClient {
  constructor(public override readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        '',
        'AAAAAwAAAAAAAAAAAAAACFR3b1Rva2VuAAAAAgAAAAAAAAABQQAAAAAAAAAAAAAAAAAAAUIAAAAAAAAB',
        ...
        '',
        ...
        'AAAAAAAAAAAAAAAIZ2V0X3Bvb2wAAAAAAAAAAQAAA+kAAAfQAAAAB1R3b1Bvb2wAAAAAAw==',
        ...
        'AAAAAAAAAAAAAAASZ2V0X3JlY2VpdmVfYW1vdW50AAAAAAADAAAAAAAAAAVpbnB1dAAAAAAAAAoAAAAAAAAACnRva2VuX2Zyb20AAAAAB9AAAAAIVHdvVG9rZW4AAAAAAAAACHRva2VuX3RvAAAH0AAAAAhUd29Ub2tlbgAAAAEAAAPpAAAD6gAAAAoAAAAD',
        'AAAAAAAAAAAAAAAPZ2V0X3NlbmRfYW1vdW50AAAAAAMAAAAAAAAABm91dHB1dAAAAAAACgAAAAAAAAAKdG9rZW5fZnJvbQAAAAAH0AAAAAhUd29Ub2tlbgAAAAAAAAAIdG9rZW5fdG8AAAfQAAAACFR3b1Rva2VuAAAAAQAAA+kAAAPqAAAACgAAAAM=',
  ...
  public readonly fromJSON = {
    ...
    get_pool: this.txFromJSON<Result<TwoPool>>,
